# USAGE
# python detect_faces_image.py --face cascades/haarcascade_frontalface_default.xml --image images/girls.jpg
...
faceRects = detector.detectMultiScale(gray, scaleFactor=1.25, minNeighbors=5,
